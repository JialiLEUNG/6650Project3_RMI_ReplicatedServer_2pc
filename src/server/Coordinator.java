...
public class Coordinator extends Thread{
    ...
    public static void main(String args[]) throws Exception{
        ...
        /**
         * The following code lets coordinator sleep for 2 minutes, and brings down server 4001.
         */
        try{
            Thread.sleep(120000);
        }catch (InterruptedException e){
        }
        LocateRegistry.getRegistry(4001).unbind("keyValService.KeyValStoreInterface");
        serverHelper.log("*********** SERVER 4001 IS DOWN! *************.");
    }
